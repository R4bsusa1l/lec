      ...
      <svg className="cpu-bus-svg" viewBox="0 0 1600 900" preserveAspectRatio="xMidYMid slice">
        <defs>
          <linearGradient id="traceGlow" x1="0" y1="0" x2="1" y2="1">
            ...
            <stop offset="55%" stopColor="#ff4d88" stopOpacity="0.7" />
            <stop offset="100%" stopColor="#ff2d6a" stopOpacity="0.55" />
          </linearGradient>
          <pattern id="busGrid" width="140" height="140" patternUnits="userSpaceOnUse">
            ...
            <path d="M0 36 H140" stroke="#ff7a45" strokeWidth="0.6" opacity="0.28" />
            <path d="M0 44 H140" stroke="#ff4d88" strokeWidth="0.6" opacity="0.22" />
            <path d="M48 0 V140" stroke="url(#traceGlow)" strokeWidth="1.2" opacity="0.32" />
            <path d="M56 0 V140" stroke="#ff9a4a" strokeWidth="0.6" opacity="0.24" />
            <path d="M64 0 V140" stroke="#ff4d88" strokeWidth="0.55" opacity="0.2" />
            <circle cx="48" cy="28" r="3.2" fill="#14060c" stroke="#ff8a5a" strokeWidth="1.1" />
            <circle cx="48" cy="28" r="1.1" fill="#ffb08a" />
            <circle cx="112" cy="92" r="3.2" fill="#14060c" stroke="#ff4d88" strokeWidth="1.1" />
            <circle cx="112" cy="92" r="1.1" fill="#ff9ab8" />
            <path d="M64 44 L96 76 L112 76 L112 92" fill="none" stroke="#ff6b55" strokeWidth="1" opacity="0.4" />
            <rect x="96" y="8" width="28" height="14" rx="1.5" fill="none" stroke="#ff7a4a" strokeWidth="0.8" opacity="0.35" />
            <rect x="8" y="100" width="22" height="22" rx="2" fill="none" stroke="#ff4d88" strokeWidth="0.8" opacity="0.3" />
          </pattern>
        </defs>
